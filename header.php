      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="index.php?continent=Oceania">Oceanie</a>
            <a class="dropdown-item" href="index.php?continent=North%20America">Amerique du nord</a>
            <a class="dropdown-item" href="index.php?continent=South%20America">Amerique du sud</a>
